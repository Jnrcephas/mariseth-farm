...
export default function UploadDocsCard({uploadedImages, setUploadedImages, multi=false}:{uploadedImages: UploadedImage[]; setUploadedImages: (image: any)=> void; multi?: boolean}) {
