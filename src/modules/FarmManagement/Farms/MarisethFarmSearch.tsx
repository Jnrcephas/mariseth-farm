...
export default function MarisethFarmSearch({setFilters, filters, isLoading}:TSearchProps){
                            ...
                            <FormItem>
                                <FormControl>
                                    <div className="relative">
                                        ...
                                        <Input className="px-10" placeholder="Search with farm ID, farm name, farm type " {...field} />
                                    </div>
                                </FormControl>
                                <FormMessage />
                            </FormItem>
