...
import LoginLogoutAuditTrails from "./LoginLogoutAuditTrails";
  ...
  return (
    <div>
        <Tabs defaultValue="1" className="w-full mx-auto">
            <TabsList className="grid w-full sm:w-[620px] grid-cols-3 h-auto p-1 bg-[#E2E8F0] rounded-full mb-5">
                <TabsTrigger
