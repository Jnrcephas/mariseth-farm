...
const EXTENSION_REQUEST_STATUS_OPTIONS = [
  { label: "Pending", value: "pending" },
  { label: "Approved", value: "approved" },
  { label: "Rejected", value: "rejected" },
];

export default function ExtensionRequestSearch({ setFilters, filters, isLoading }: TSearchProps) {
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select onValueChange={field.onChange} value={field.value}>
                      ...
                      <SelectContent>
                        {EXTENSION_REQUEST_STATUS_OPTIONS.map((item) => (
